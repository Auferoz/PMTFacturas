<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->isSMTP();
		$mail->SMTPAuth = true;
		$mail->Host = 'mail.mianuncioweb.cl';
		
		$mail->Username = 'facturaspmt@mianuncioweb.cl';
		$mail->Password = 'facturaspmt2019';
		
		$mail->setFrom('facturaspmt@mianuncioweb.cl', 'Facturas PMT');
