<?php 
	...
	$sql_modf = "SELECT * FROM proveedores";
	...
	if($_GET){
        ...
        $sql_provd = "SELECT * FROM proveedores WHERE id_proveedor=?";
        $gsent_uprov = $pdo->prepare($sql_provd);
        $gsent_uprov->execute(array($id_proveedor));
        $modf_proveedor = $gsent_uprov->fetch();
    }
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    <table class="table LoginAprobar" style="color:#FFF;">
                        ...
                        <tr>
                            <td class="tdstyle">
                                <h5><?php echo $row_modf['id_proveedor'];?></h5>
                            </td>
                            <td class="tdstyle">
                                <h5><?php echo $row_modf['nombre_proveedor'];?></h5>
                                <h5><?php echo $row_modf['rut_proveedor'];?></h5>
                            </td>
                            <td>
                                <a href="modf_proveedores.php?id_proveedor=<?php echo $row_modf['id_proveedor'];?>" class="btn special-color mr-5"><i class="fas fa-user-edit"></i> Editar</a>
                                <a target="_blank" href="#" data-target="#confirm-delete" data-toggle="modal" data-href="modf_proveedores_delete.php?id_proveedor=<?php echo $row_modf['id_proveedor'];?>"><i class="far fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        <?php endforeach ?>
                    </table>
                ...
                <div class="col-xs-6 col-md-6">
                    <?php if($_GET):?>
                    <form action="modf_proveedores_edit.php" method="GET">
                        <div class="form-group LoginAprobar p-3">
                            <div class="row">
                                <div class="col-xs-12 col-md-12">
                                    <h4 class="text-white">Proveedor a Modificar: <?php echo $modf_proveedor['nombre_proveedor'];?></h4>
                                    <input type="hidden" name="id_proveedor" value="<?php echo $modf_proveedor['id_proveedor'];?>">
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <label for="inputnombre" class="col-form-label text-white">Nombre del Proveedor:</label>
                                    <input type="text" id="inputnombre" class="form-control" name="nombre_proveedor" placeholder="" value="<?php echo $modf_proveedor['nombre_proveedor'];?>" required>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <label for="inputcorreo" class="col-form-label text-white">Rut del Proveedor:</label>
                                    <input type="text" id="inputcorreo" class="form-control" name="rut_proveedor" placeholder="" value="<?php echo $modf_proveedor['rut_proveedor'];?>" required>
                                </div>
                                <div class="col-xs-12 col-md-12">
