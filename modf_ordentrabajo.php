<?php 
	...
	$sql_modf = "SELECT * FROM orden_de_trabajo";
	...
	if($_GET){
        $id_ot = $_GET['id_ot'];
        $sql_provd = "SELECT * FROM orden_de_trabajo WHERE id_ot=?";
        $gsent_uprov = $pdo->prepare($sql_provd);
        $gsent_uprov->execute(array($id_ot));
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    <table class="table LoginAprobar" style="color:#FFF;" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td class="tdstyle">
                                <h6><?php echo $row_modf['id_ot'];?></h6>
                            </td>
                            <td class="tdstyle">
                                <h6><?php echo $row_modf['ot_nombre_obra'];?></h6>
                                <h6><?php echo $row_modf['ot_direccion_obra'];?></h6>
                                <h6><?php echo $row_modf['ot_mandante'];?></h6>
                            </td>
                            <td>
                                <a href="modf_ordentrabajo.php?id_ot=<?php echo $row_modf['id_ot'];?>" class="btn special-color mr-5"><i class="fas fa-user-edit"></i> Editar</a>
                                <a target="_blank" href="#" data-target="#confirm-delete" data-toggle="modal" data-href="modf_ordentrabajo_delete.php?id_ot=<?php echo $row_modf['id_ot'];?>"><i class="far fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        <?php endforeach ?>
                    </table>
                ...
                <div class="col-xs-6 col-md-6">
                    <?php if($_GET):?>
                    <form action="modf_ordentrabajo_edit.php" method="GET">
                        <div class="form-group LoginAprobar p-3">
                            <div class="row">
                                <div class="col-xs-12 col-md-12">
                                    <h4 class="text-white">Orden de Trabajo a Modificar: <?php echo $modf_dattos['ot_nombre_obra'];?></h4>
                                    <input type="hidden" name="id_ot" value="<?php echo $modf_dattos['id_ot'];?>">
                                </div>
                                <div class="col-xs-12 col-md-12">
                                    <label for="inputnombre" class="col-form-label text-white">Nombre de la Obra:</label>
                                    <input type="text" id="inputnombre" class="form-control" name="ot_nombre_obra" placeholder="" value="<?php echo $modf_dattos['ot_nombre_obra'];?>" required>
                                </div>
                                <div class="col-xs-12 col-md-12">
                                    <label for="inputcorreo" class="col-form-label text-white">Direccion de la Obra:</label>
                                    <input type="text" id="inputcorreo" class="form-control" name="ot_direccion_obra" placeholder="" value="<?php echo $modf_dattos['ot_direccion_obra'];?>" required>
                                </div>
                                <div class="col-xs-12 col-md-12">
                                    <label for="inputcorreo" class="col-form-label text-white">Mandante de la Obra:</label>
                                    <input type="text" id="inputcorreo" class="form-control" name="ot_mandante" placeholder="" value="<?php echo $modf_dattos['ot_mandante'];?>" required>
                                </div>
                                <div class="col-xs-12 col-md-12">
